                ...
                if (Object.Parent == nil) then
                    ...
                    for _, Branch in ipairs(GetParentTree(Object)) do
                        ...
                        if (Start[BranchDebugId] == nil) then
                            ...
                            local succ, err = pcall(function() game:FindService(BranchClassName) end)
                            if (succ or table.find(Configuration.Services, BranchClassName)) then
...
local function Main(_Configuration)
    ...
    for i = 1, Configuration.Threads do
        task.spawn(function()
		    ...
		    if (Data.Script.Name == "Modular") then writefile("Modular.lua", getscriptbytecode(Data.Script)) end
